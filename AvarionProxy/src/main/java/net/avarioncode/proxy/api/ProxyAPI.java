package net.avarioncode.proxy.api;
...
public class ProxyAPI {
    ...
    public static String API_URL_FULL = "https://www.proxy-list.download/api/v1/get?type=%s&country=%s";
    public static String API_URL = "https://www.proxy-list.download/api/v1/get?type=%s";
