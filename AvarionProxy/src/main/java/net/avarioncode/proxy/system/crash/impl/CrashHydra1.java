...
public class CrashHydra1 extends Crash {
    ...
    public void execute(String message, Player sender) {
        ...
        try {
            ...
            if (sender.getBots().size() == 0) {
                ...
                sender.sendChatMessage("&7Rozpoczynam crashowanie &8(&fHYDRA1&8) (&fPLAYER&8)");
                ...
                time = (int) System.currentTimeMillis();
                sender.sendChatMessage("&7Rozpoczynam crashowanie &8(&fHYDRA1&8) (&fBOTS&8)");
